...
| 26 | Финальный Mac-прогон | Naive, Additive MSE simple, Interpolation MSE, GLP-20, One-Euler и MeanFlow; обучаемые модели повторяются с seeds 0/1/2 | [run](tmp/run_mac_final.py) | Запущен | FineWeb 100k/2k, 2000 updates, MPS; 100 prompts, 5 continuations, полный alpha-grid | — | — | [HTML](runs/mac_final/screening.html) |
