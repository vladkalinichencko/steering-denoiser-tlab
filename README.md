# Steering GPT-2 без деградации текста

Денойзер возвращает активацию, сдвинутую линейным steering, обратно к естественным активациям.
...
| из отчёта | в коде |
|---|---|
| наивный сдвиг без починки | `baseline.py`, `repairs/none.py` |
